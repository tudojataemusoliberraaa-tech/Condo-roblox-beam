...
const copy = {
  ...
  pt: {
    ...
    generate: 'Gere seu', tokenNote: 'abaixo para verificar sua sessão e entrar no jogo.', generateAccess: 'Gerar Token de Acesso', access: 'Acessar Jogo', copied: 'Token copiado', generated: 'Token de acesso gerado', warning: 'Gere um token primeiro para acessar o jogo.', choose: 'Escolha seu idioma', chooseNote: 'Selecione um idioma para continuar.', language: 'Idioma', loginTitle: 'Verifique sua conta Roblox', loginNote: 'Digite seu nome de usuário público do Roblox. Nunca pedimos sua senha.', usernamePlaceholder: 'Nome de usuário do Roblox', verify: 'Verificar conta', verifying: 'Verificando conta…', accountNotFound: 'Conta não encontrada. Tente outro nome de usuário.', accountTooYoung: (days: number) => `Esta conta ainda não tem idade suficiente. Faltam ${days} dia${days === 1 ? '' : 's'} para completar 80 dias.`, accountVerified: 'Conta verificada.', verifyError: 'Não foi possível verificar a conta. Tente novamente.', loginRequired: 'Verifique sua conta antes de abrir um jogo.',
  },
  ru: {
